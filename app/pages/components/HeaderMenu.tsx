    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="https://res.cloudinary.com/dxorrp9np/image/upload/v1715555200/favicon.webp" className="h-8" alt="PokeApp Logo" />
          <img src="https://res.cloudinary.com/dxorrp9np/image/upload/v1715619495/logo.png" className="h-8" alt="PokeApp Logo" />
        </a>
